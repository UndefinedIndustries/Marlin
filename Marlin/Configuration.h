...
#define CUSTOM_MACHINE_NAME "PrintMAKER"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "31bddce1-59bd-48f4-b3f9-d0c631ce6aa8"
...
//
#define Z_PROBE_DEPLOY_HEIGHT 1 // Z position for the probe to deploy/stow
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {79.94,80.04,1523.71,94.8}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {500, 500, 600, 250}    // (mm/sec)
